...
app.config(function appConfig($routeProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $locationProvider) {
	...
	$routeProvider
		.when('/', {
			...
			title: 'Home',
			resolve: _requireDependencies(['/scripts/controllers/MainController.js', '/components/suncalc/suncalc.js', '/scripts/directives/phase.js', '/scripts/services/suncalc.js'])
		})
		.when('/search/', {
			templateUrl: '/views/main.html',

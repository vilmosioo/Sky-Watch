...
module SkyWatch.Directives {
    ...
    export var cards: ng.Injectable<ng.IDirectiveFactory> = ($window, $interval, $timeout, $rootScope, Constants, Converter, Geo, SunCalc) => ({
        $inject: ["$window", "$interval", "$timeout", "$rootScope", "Constants", "Converter", "Geo", "SunCalc"],
